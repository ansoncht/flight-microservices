...
//
//	mockgen -source pkg/kafka/reader.go -destination=internal/test/mock/mock_reader.go -package=mock
//
...
func (m *MockMessageReader) ReadMessages(ctx context.Context, msgChan chan<- kafka.Message) error {
	m.ctrl.T.Helper()
