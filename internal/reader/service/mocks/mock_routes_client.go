...
// Source: internal/reader/client/routes.go
//
// Generated by this command:
//
//	mockgen -source internal/reader/client/routes.go -destination=internal/reader/service/mocks/mock_routes_client.go -package=mocks
//
